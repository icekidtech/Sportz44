...
func RegisterRoutes(
	...
	)
	{
		...
		protected.GET("/matches/:id/sync-lineup", match.SyncMatchLineup)
		protected.GET("/matches/:id/sync-stats", match.SyncMatchStats)
		protected.GET("/matches/:id/sync-details", match.SyncMatchDetails)
