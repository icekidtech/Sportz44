...
type MatchEvent struct {
	...
	MatchID    uint      `gorm:"index:idx_match_events_match,priority:1" json:"match_id"`
	Minute     int       `gorm:"index:idx_match_events_match,priority:2" json:"minute"`
	EventType  string    `gorm:"size:30;index" json:"event_type"` // goal | card | substitution | injury | own_goal | penalty
